...
function 함수2_2(a :string | undefined){
...
function 함수2_2_1(animal :Fish | Bird){ // typeof 연산자는 number, string, boolean, object 등 이런 식으로만 판정가능
    /* if ( typeof animal === ) {
        animal.swim
    }*/
...
// 오브젝트 instanceof 부모class // 3. instanceof 키워드로 object narrowing 가능
/* let 날짜 = new Date();
...
function 함수2_2_2(x :Car2_2 | Bike2_2){
