...
var 제목2 = document.querySelector('#title'); // narrowing3 : as 문법 -> 제목2는 Element 타입으로 강제 지정됨, TS 쓰는 의미가 없음
if (제목 === null || 제목 === void 0 ? void 0 : 제목.innerHTML) { // narrowing4 : ?. 연산자 -> 1. 제목에 innerHTML이 있으면 출력 2. 없으면 undefined 출력 (optinal chaining)
    제목.innerHTML = '반가워요';
}
...
var 버튼 = document.querySelector('#button'); // TS에서 eventListener 부착하는 방법
...
*/
var 링크1_8 = document.querySelectorAll('.naver');
링크1_8.forEach(function (a) {
